...
# ============================================
# This is created by Terraform automatically - no manual OIDC setup needed!
# The workflow uses these IDs for passwordless authentication
...
# ============================================
# Depends on: GitHub Actions SP, Resource Group, ACR, AKS
...
# ============================================
# Depends on: Workload Identity, PostgreSQL
# Allows pods to connect to PostgreSQL using Azure AD authentication
